...
workerRouter.get('/get-order-note/', tokenValidation, getOrderNote) // order-notes
...
workerRouter.patch('/profile', tokenValidation, uploader, limiter, updateProfileWorkerValidation, expressValidatorErrorHandling, updateProfileWorker) // ganti /
