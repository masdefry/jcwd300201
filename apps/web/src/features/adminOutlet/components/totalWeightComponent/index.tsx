    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <div className="relative">
                <Field name="totalWeight" type="number" placeholder="Enter total weight" className="w-full py-2 text-sm px-3 focus:outline-none border-b focus:border-orange-500 rounded-md" min="1" step="1" />
                <ErrorMessage
                    name="totalWeight"
                    component="div"
