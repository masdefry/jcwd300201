        ...
        <div className="flex w-full flex-col items-center pb-4">
            ...
            <Tabs defaultValue="today" className="w-full">
                <TabsList className="flex space-x-4 bg-orange-100">
                    <TabsTrigger value="today" onClick={() => setSelectedTab('today')}>Hari Ini</TabsTrigger>
                    <TabsTrigger value="month" onClick={() => setSelectedTab('month')} >Bulan Ini</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="today">
                    <div className="grid grid-cols-2 lg:grid-cols-1 lg:grid-rows-2 gap-4 mt-4">
                        ...
                        <div className="p-2">
                            <h2 className=" font-semibold text-gray-800">Total Kg & Pcs</h2>
                            <p className="text-sm text-gray-500 mt-2">
