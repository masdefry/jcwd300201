...
export function ConfirmAlert({ caption, btnConfrimCaption = 'Konfirmasi', btnCancelCaption = 'Batal',
    ...
    children, onClick, colorConfirmation='red' }: IConfirmAlert) {
        ...
        <AlertDialog>
            ...
            < AlertDialogContent >
                ...
                < AlertDialogFooter >
                    ...
                    <AlertDialogAction className={`bg-${colorConfirmation}-600 hover:bg-${colorConfirmation}-700`} onClick={onClick}>{btnConfrimCaption}</AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
    )
